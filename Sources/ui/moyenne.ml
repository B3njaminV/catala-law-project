...
module Moyenne_in = struct
  type t = {notes_in: integer array}
end


let moyenne (moyenne_in: Moyenne_in.t) : Moyenne.t =
  let notes_: integer array = moyenne_in.Moyenne_in.notes_in in
  let total_: integer =
    try
      (handle_default
         {filename = "moyenne.catala_fr"; start_line=8; start_column=11;
           end_line=8; end_column=16;
           law_headings=["Code Catala"; "Calcul de Moyenne"]}
         ([|(fun (_: unit) ->
               handle_default
                 {filename = "moyenne.catala_fr"; start_line=8;
  ...
  let nb_notes_: integer =
    try
      (handle_default
         {filename = "moyenne.catala_fr"; start_line=7; start_column=11;
           end_line=7; end_column=19;
           law_headings=["Code Catala"; "Calcul de Moyenne"]}
         ([|(fun (_: unit) ->
               handle_default
                 {filename = "moyenne.catala_fr"; start_line=7;
  ...
  let moy_: decimal =
    try
      (handle_default
         {filename = "moyenne.catala_fr"; start_line=9; start_column=12;
           end_line=9; end_column=15;
           law_headings=["Code Catala"; "Calcul de Moyenne"]}
         ([|(fun (_: unit) ->
               handle_default
                 {filename = "moyenne.catala_fr"; start_line=9;
